...
export default function Register() {
  ...
  const createMutation = useMutation({
    mutationFn: async (data) => {
      ...
      return base44.entities.Clinic.create({
        ...
        <Card className="max-w-md w-full">
          <CardContent className="p-8 text-center">
            ...
            <div className="bg-muted/50 rounded-lg p-4 text-sm text-left space-y-2 mb-6">
              <p><span className="text-muted-foreground">院名:</span> <span className="font-medium">{form.clinicName}</span></p>
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Link to="/" className="flex items-center justify-center gap-1 mt-6 text-sm text-muted-foreground hover:text-foreground">
